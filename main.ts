...
let Heart = sprites.create(img`
    ...
    ....................
    `, SpriteKind.Player)
tiles.placeOnTile(Heart, tiles.getTileLocation(8, 10))
Render.setSpriteAttribute(Heart, RCSpriteAttribute.ZOffset, 10)
...
game.onUpdate(function () {
    if (Render.isSpritesOverlapZ(mySprite, Heart) && mySprite.overlapsWith(Heart)) {
        info.changeLifeBy(1)
